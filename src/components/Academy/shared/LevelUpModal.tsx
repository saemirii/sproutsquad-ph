...
export const LevelUpModal: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Icon name={pendingLevelUp.icon} className="w-16 h-16 mx-auto animate-bounce" />
        ...
        <button
          onClick={clearPendingLevelUp}
          className="btn-bouncy w-full mt-2 rounded-2xl bg-[#207559] hover:bg-[#194E3B] text-white text-xs font-black px-4 py-3 cursor-pointer flex items-center justify-center gap-1.5"
        >
          Keep Growing <Icon name="level-sprout" className="w-3.5 h-3.5" />
        </button>
      </div>
    </div>
  );
